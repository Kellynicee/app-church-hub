  ...
  head: () => ({
    meta: [
      ...
      { title: "Morningstar Covenant Int'l Church" },
      {
        name: "description",
        content:
          "Morningstar Covenant International Church — a modern, app-style home for worship, sermons, events and community.",
      },
      { name: "theme-color", content: "#0f1734" },
      { property: "og:title", content: "Morningstar Covenant Int'l Church" },
      {
        property: "og:description",
        content:
          "A modern, app-style home for worship, sermons, events and community.",
      },
